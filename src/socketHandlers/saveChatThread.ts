...
export const saveChatThread = async (userId: mongoose.Types.ObjectId, shopId: string, userQuery: string, gptResponse: string) => {  
    ...
    try {
        ...
        console.log("recommendations:",jsonObject.recommendations)
    ...
    if (existingChatThread) {
            console.log("FOUND A USER", userId)
            ...
            console.log("DIDNT FIND A USER, but the user is ", userId)
...
export const saveStringChatThread = async (userId: mongoose.Types.ObjectId, shopId: string, userQuery: string, gptResponse: string) => {  
